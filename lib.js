...
/*
두물체간 충돌여부를 판단하기 위함 함수이다

즉 함수 호출시 물체A는 me전달하고 물체 B는 Target으로 전달하자
return 값이 true 이면 두 물체는 서로 교차하고있는 상태이다!!
*/
...
function getLastDate(year,month){
	...
	d.setMonth(month);
	d.setFullYear(year);
	d.setDate(0);//이전월의 마지막날!
	var lastDate=d.getDate();
	
	//alert(year+"년"+month+"월은 총"+lastDate+"까지!");
